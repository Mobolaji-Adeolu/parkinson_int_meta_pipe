...
for genome_name in sorted(os.walk(input_folder).next()[1]):
    ...
    for item in sorted(file_list):
        ...
        if startpoint <= sp['Pre'] and endpoint >= sp['Pre']:
            ...
            # FIND & REMOVE HOST CONTAMINANTS (BWA):
            ...
            # FIND & REMOVE VECTOR CONTAMINANTS (BWA):
            ...
            # REMOVE BLAT VECTOR CONTAMINANTS:
        ...
        if startpoint <= sp['rRNA'] and endpoint >= sp['rRNA']:
            ...
            # this creates a whole lot of (quick-running) subjobs as things get split further
