...
for genome_name in sorted(os.walk(input_folder).next()[1]):
    ...
    for item in sorted(file_list):
        ...
        if startpoint <= sp['Pre'] and endpoint >= sp['Pre']:
            ...
            #
            # ISOLATE TEST:
            Python + " " + BLAT_Isolate_Filter + " " + Input_Filepath + "_unpaired_host_contaminants.fastq" + " " + Input_Filepath + "_unpaired_n_BWA_host_contaminants.fastq" + " " + Input_Filepath + "_unpaired_n_host_contaminants.blatout" + " " + Input_Filepath + "_unpaired_n_host_contaminants.fastq.TEST" + " " + Input_Filepath + "_unpaired_BLAT_host_contaminants.fastq.TEST" + " " + Input_Filepath + "unpaired_BWABLAT_host_contaminants.fastq.TEST",
            Python + " " + BLAT_Isolate_Filter + " " + Input_File1 + "_paired_host_contaminants.fastq" + " " + Input_File1 + "_paired_n_BWA_host_contaminants.fastq" + " " + Input_File1 + "_paired_n_host_contaminants.blatout" + " " + Input_File1 + "_paired_n_host_contaminants.fastq.TEST" + " " + Input_File1 + "_paired_BLAT_host_contaminants.fastq.TEST" + " " + Input_File1 + "paired_BWABLAT_host_contaminants.fastq.TEST",
            Python + " " + BLAT_Isolate_Filter + " " + Input_File2 + "_paired_host_contaminants.fastq" + " " + Input_File2 + "_paired_n_BWA_host_contaminants.fastq" + " " + Input_File1 + "_paired_n_host_contaminants.blatout" + " " + Input_File2 + "_paired_n_host_contaminants.fastq.TEST" + " " + Input_File2 + "_paired_BLAT_host_contaminants.fastq.TEST" + " " + Input_File2 + "paired_BWABLAT_host_contaminants.fastq.TEST",
            #
            #
            #
