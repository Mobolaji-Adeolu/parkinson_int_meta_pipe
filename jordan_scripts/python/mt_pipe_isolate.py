...
# - Added step to isolate data, e.g., from a specific taxa.
...
# - Uses rRNA_isolate_split_jobs.py instead of rRNA_Split_Jobs.py, in order to call the
#   output files from isolate, instead of vector removal.
...
start_order = ['Pre', 'Isolate', 'rRNA', 'Assemble', 'Annotate_BWA', 'Annotate_BWA_Post', 'Annotate_BLAT', 'Annotate_BLAT_Post', 'Annotate_Diamond', 'Annotate_Diamond_Post', 'Classify', 'EC_Preprocess', 'Detect', 'PRIAM', 'EC_Diamond', 'EC_Postprocess', 'Network']
...
for genome_name in sorted(os.walk(input_folder).next()[1]):
    ...
    for item in sorted(file_list):
        ...
        if startpoint <= sp['Isolate'] and endpoint >= sp['Isolate']
            ...
            BWA + " mem -t " + Threads + " " + TAXA_DNA_DB + " " + Input_Filepath + "_unpaired_n_contaminants.fastq" + " > " + Input_Filepath + "_unpaired_BWA_isolate.sam",
            SAMTOOLS + " view -bS " + Input_Filepath + "_unpaired_BWA_isolate.sam" + " > " + Input_Filepath + "_unpaired_BWA_isolate.bam",
            SAMTOOLS + " fastq -n -f 4" + " -0 " + Input_Filepath + "_unpaired_n_BWA_isolate.fastq" + " " + Input_Filepath + "_unpaired_BWA_isolate.bam",
            SAMTOOLS + " fastq -n -F 4" + " -0 " + Input_Filepath + "_unpaired_BWA_isolate.fastq" + " " + Input_Filepath + "_unpaired_BWA_isolate.bam",
            BWA + " mem -t " + Threads + " " + TAXA_DNA_DB + " " + Input_File1 + "_paired_n_contaminants.fastq" + " " + Input_File2 + "_paired_n_contaminants.fastq" + " > " + Input_Filepath + "_paired_BWA_isolate.sam",
            SAMTOOLS + " view -bS " + Input_Filepath + "_paired_BWA_isolate.sam" + " > " + Input_Filepath + "_paired_BWA_isolate.bam",
            SAMTOOLS + " fastq -n -f 13" + " -1 " + Input_File1 + "_paired_n_BWA_isolate.fastq" + " -2 " + Input_File2 + "_paired_n_BWA_isolate.fastq" + " " + Input_Filepath + "_paired_BWA_isolate.bam",
            SAMTOOLS + " fastq -n -F 4" + " -1 " + Input_File1 + "_paired_BWA_isolate.fastq" + " -2 " + Input_File2 + "_paired_BWA_isolate.fastq" + " " + Input_Filepath + "_paired_BWA_isolate.bam",
            # FIND TAXA ALIGNMENTS (BLAT):
            vsearch + " --fastq_filter " + Input_Filepath + "_unpaired_n_BWA_isolate.fastq" + " --fastq_ascii " + Qual + " --fastaout " + Input_Filepath + "_unpaired_n_BWA_isolate.fasta",
            BLAT + " -noHead -minIdentity=90 -minScore=65 " + TAXA_DNA_DB + " " + Input_Filepath + "_unpaired_n_BWA_isolate.fasta" + " -fine -q=rna -t=dna -out=blast8 -threads=" + Threads + " " + Input_Filepath + "_unpaired_n_isolate.blatout",
            vsearch + " --fastq_filter " + Input_File1 + "_paired_n_BWA_isolate.fastq" + " --fastq_ascii " + Qual + " --fastaout " + Input_File1 + "_paired_n_BWA_isolate.fasta",
            BLAT + " -noHead -minIdentity=90 -minScore=65 " + TAXA_DNA_DB + " " + Input_File1 + "_paired_n_BWA_isolate.fasta" + " -fine -q=rna -t=dna -out=blast8 -threads=" + Threads + " " + Input_File1 + "_paired_n_isolate.blatout",
            vsearch + " --fastq_filter " + Input_File2 + "_paired_n_BWA_isolate.fastq" + " --fastq_ascii " + Qual + " --fastaout " + Input_File2 + "_paired_n_BWA_isolate.fasta",
            BLAT + " -noHead -minIdentity=90 -minScore=65 " + TAXA_DNA_DB + " " + Input_File2 + "_paired_n_BWA_isolate.fasta" + " -fine -q=rna -t=dna -out=blast8 -threads=" + Threads + " " + Input_File2 + "_paired_n_isolate.blatout",
            # REMOVE BLAT TAXA ALIGNMENTS:
            Python + " " + BLAT_Isolate_Filter + " " + Input_Filepath + "_unpaired_BWA_isolate.fastq" + " " + Input_Filepath + "_unpaired_n_BWA_isolate.fastq" + " " + Input_Filepath + "_unpaired_n_isolate.blatout" + " " + Input_Filepath + "_unpaired_n_isolate.fastq" + " " + Input_Filepath + "_unpaired_BLAT_isolate.fastq" + " " + Input_Filepath + "unpaired_isolate.fastq",
            Python + " " + BLAT_Isolate_Filter + " " + Input_File1 + "_paired_BWA_isolate.fastq" + " " + Input_File1 + "_paired_n_BWA_isolate.fastq" + " " + Input_File1 + "_paired_n_isolate.blatout" + " " + Input_File1 + "_paired_n_isolate.fastq" + " " + Input_File1 + "_paired_BLAT_isolate.fastq" + " " + Input_File1 + "paired_isolate.fastq",
            Python + " " + BLAT_Isolate_Filter + " " + Input_File2 + "_paired_BWA_isolate.fastq" + " " + Input_File2 + "_paired_n_BWA_isolate.fastq" + " " + Input_File1 + "_paired_n_isolate.blatout" + " " + Input_File2 + "_paired_n_isolate.fastq" + " " + Input_File2 + "_paired_BLAT_isolate.fastq" + " " + Input_File2 + "paired_isolate.fastq",
            ]

            with open(os.path.splitext(Input_FName)[0] + "_Isolate.pbs", "w") as PBS_script_out:
                for line in PBS_Submit.splitlines():
                    if "WALLTIME" in line:
                        line = line.replace("WALLTIME", "walltime=01:00:00")
                    if "NAME" in line:
                        line = line.replace("NAME", os.path.splitext(Input_FName)[0] + "_Isolate")
                    if "COMMANDS" in line:
                        PBS_script_out.write("\n".join(COMMANDS_Isolate))
                        break
                    PBS_script_out.write(line + "\n")

            if startpoint > sp['Pre']:
                print "...started"
                JobID_Isolate = subprocess.check_output(["qsub", os.path.splitext(Input_FName)[0] + "_Isolate.pbs"])
            else:
                print "...queued"
                JobID_Isolate = subprocess.check_output(["qsub", os.path.splitext(Input_FName)[0] + "_Isolate.pbs", "-W", "depend=afterok:" + JobID_Pre.strip("\n")])
        ...
        if startpoint <= sp['rRNA'] and endpoint >= sp['rRNA']:
            ...
            if startpoint > sp['Isolate']:
                ...
                print "...queued"
                JobID_rRNA = subprocess.check_output(["qsub", os.path.splitext(Input_FName)[0] + "_rRNA_Submit.pbs", "-W", "depend=afterok:" + JobID_Isolate.strip("\n")])
            ...
            with open(os.path.splitext(Input_FName)[0] + "_Annotate_BWA.pbs", "w") as PBS_script_out:
                for line in PBS_Submit_Mem.splitlines():
                    if "NODES_MEM_CORES" in line:
                        line = line.replace("NODES_MEM_CORES", "nodes=1:m32g:ppn=16")
                    if "WALLTIME" in line:
                        line = line.replace("WALLTIME", "walltime=00:15:00")
                    if "NAME" in line:
